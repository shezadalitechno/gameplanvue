...
const { results, loading, error, refetch } = useEmployeeQueries(QueryType.NOT_UPDATED_YESTERDAY)
...
<template>
  <UDashboardPanel id="not-updated-yesterday">
    <template #header>
      <UDashboardNavbar title="Employees Not Updated Yesterday">
        <template #leading>
    ...
    <template #body>
      ...
      <CommonEmptyDataState
        ...
        title="All employees updated yesterday"
        description="Great! All employees updated their tasks yesterday."
